...
describe('posts', () => {
  ...
  scenario('creates a post', async () => {
    const result = await createPost({
      input: {
        updatedAt: '2023-04-05T02:22:40.456Z',
        title: 'String',
        body: 'String',
      },
    })

    expect(result.updatedAt).toEqual(new Date('2023-04-05T02:22:40.456Z'))
  ...
  scenario('updates a post', async (scenario) => {
    ...
    const result = await updatePost({
      id: original.id,
      input: { updatedAt: '2023-04-06T02:22:40.456Z' },
    })

    expect(result.updatedAt).toEqual(new Date('2023-04-06T02:22:40.456Z'))
  })
